...
public class NgoClothesDonationDetails extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngo_clothes_donation_details);
        ...
        mInstaList.setLayoutManager(new LinearLayoutManager(NgoClothesDonationDetails.this));
        mAuth = FirebaseAuth.getInstance();
        mDatabaseUser = mAuth.getCurrentUser().getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Ngo").child("Clothes");
        fetch();
    }
        ...
        adapter = new FirebaseRecyclerAdapter<Ngo,ViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull Ngo model) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getApplicationContext(),NgoSingleClothesDonationDetails.class);
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view = LayoutInflater.from(viewGroup.getContext())
                        ...
                        .inflate(R.layout.ngo_clothes_card, viewGroup, false);
    ...
    public void details(){
        swipeRefreshLayout.setRefreshing(true);
    FirebaseRecyclerAdapter<Ngo,NgoClothesDonationDetails.InstaViewHolder> FBRA = new FirebaseRecyclerAdapter<Ngo, NgoClothesDonationDetails.InstaViewHolder>(Ngo.class,R.layout.ngo_clothes_card,NgoClothesDonationDetails.InstaViewHolder.class,mDatabase) {
        @Override
        protected void populateViewHolder(NgoClothesDonationDetails.InstaViewHolder viewHolder, Ngo model, int position) {
            ...
            viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(NgoClothesDonationDetails.this,NgoSingleClothesDonationDetails.class);
                    intent.putExtra("PostId",post_key);
