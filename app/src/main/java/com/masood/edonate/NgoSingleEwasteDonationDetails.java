...
public class NgoSingleEwasteDonationDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngo_single_ewaste_donation_details);
    ...
    public void acceptButtonClicked(View view){
        ...
        final DatabaseReference Post =  FirebaseDatabase.getInstance().getReference().child("DonationAccepted").child("Ewaste").child(mAuth.getCurrentUser().getUid()).push();
                ...
                Post.child("email").setValue(dataSnapshot.child("email").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(NgoSingleEwasteDonationDetails.this,"Donation Accepted",Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(NgoSingleEwasteDonationDetails.this,NgoHome.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
    ...
    public void DonationAccepted(final String time,final String userid){
        final DatabaseReference post = FirebaseDatabase.getInstance().getReference().child("Donors").child("Ewaste").child(userid);
