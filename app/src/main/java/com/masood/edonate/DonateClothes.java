...
public class DonateClothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donate_clothes);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("Donate Clothes");
        ...
        addressField = (EditText) findViewById(R.id.clothesPickup);
        quantityField = (EditText)findViewById(R.id.clothesQuantity);
        username = (TextView) findViewById(R.id.userName);
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Donors").child("Clothes");
        mAuth = FirebaseAuth.getInstance();
        mCurrentUser =mAuth.getCurrentUser();
        mDatabaseUser = FirebaseDatabase.getInstance().getReference().child("DonorUser").child(mCurrentUser.getUid());

    }
    public void donateClothesButtonClicked(View view){
        ...
        if(!TextUtils.isEmpty(address) && !TextUtils.isEmpty(quantity)) {
            ...
            final DatabaseReference Post = FirebaseDatabase.getInstance().getReference().child("Donors").child("Clothes").child(userid).push();
                    ...
                    Post.child("time").setValue(currentTime).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(DonateClothes.this, "Your Request for Donation Clothes is Successful", Toast.LENGTH_LONG).show();
                                Intent intent = new Intent(DonateClothes.this, Home.class);
            ...
            final DatabaseReference Posts = FirebaseDatabase.getInstance().getReference().child("Ngo").child("Clothes").push();
            mDatabaseUser.addValueEventListener(new ValueEventListener() {
                @Override
