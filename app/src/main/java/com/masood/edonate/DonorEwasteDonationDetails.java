...
public class DonorEwasteDonationDetails extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_ewaste_donation_details);
        ...
        mInstaList.setLayoutManager(new LinearLayoutManager(DonorEwasteDonationDetails.this));
        mAuth = FirebaseAuth.getInstance();
        mDatabaseUser = mAuth.getCurrentUser().getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Donors").child("Ewaste").child(mDatabaseUser);
        ...
        adapter = new FirebaseRecyclerAdapter<Donor,ViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull Donor model) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getApplicationContext(),SingleEwasteDonationDetails.class);
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view = LayoutInflater.from(viewGroup.getContext())
                        ...
                        .inflate(R.layout.donor_ewaste_card, viewGroup, false);
    ...
    public void details(){
    swipeRefreshLayout.setRefreshing(true);
        FirebaseRecyclerAdapter<Donor,DonorEwasteDonationDetails.InstaViewHolder> FBRA = new FirebaseRecyclerAdapter<Donor, DonorEwasteDonationDetails.InstaViewHolder>(Donor.class,R.layout.donor_ewaste_card,DonorEwasteDonationDetails.InstaViewHolder.class,mDatabase) {
        @Override
        protected void populateViewHolder(DonorEwasteDonationDetails.InstaViewHolder viewHolder, Donor model, int position) {
            ...
            viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(DonorEwasteDonationDetails.this,SingleEwasteDonationDetails.class);
                    intent.putExtra("PostId",post_key);
