...
public class NgoAcceptedClothesDonationDetails extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngo_accepted_clothes_donation_details);
        ...
        mInstaList.setLayoutManager(new LinearLayoutManager(NgoAcceptedClothesDonationDetails.this));
        mAuth = FirebaseAuth.getInstance();
        mDatabaseUser = mAuth.getCurrentUser().getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child("DonationAccepted").child("Clothes").child(mDatabaseUser);
        fetch();
    }
        ...
        adapter = new FirebaseRecyclerAdapter<NgoAccepted,ViewHolder>(options) {
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view = LayoutInflater.from(viewGroup.getContext())
                        ...
                        .inflate(R.layout.ngo_accepted_clothes_card, viewGroup, false);
...
public void details(){
    ...
    swipeRefreshLayout.setRefreshing(true);
    FirebaseRecyclerAdapter<NgoAccepted,NgoAcceptedBookDonationDetails.InstaViewHolder> FBRA = new FirebaseRecyclerAdapter<NgoAccepted, NgoAcceptedBookDonationDetails.InstaViewHolder>(NgoAccepted.class,R.layout.ngo_accepted_clothes_card,NgoAcceptedBookDonationDetails.InstaViewHolder.class,mDatabase) {
        @Override
...
/*      viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(NgoAcceptedClothesDonationDetails.this,NgoSingleAcceptedClothesDonationDetails.class);
                        intent.putExtra("PostId",post_key);
