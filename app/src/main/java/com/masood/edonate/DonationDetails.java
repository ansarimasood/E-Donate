...
public class DonationDetails extends AppCompatActivity implements OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mInstaList.setLayoutManager(new LinearLayoutManager(DonationDetails.this));
        mAuth = FirebaseAuth.getInstance();
        mDatabaseUser = mAuth.getCurrentUser().getUid();
        mDatabase = FirebaseDatabase.getInstance().getReference().child("Donors").child("Books").child(mDatabaseUser);
        ...
        adapter = new FirebaseRecyclerAdapter<Donor,ViewHolder>(options) {
               ...
               // holder.setImage(getApplicationContext(),model.getImage());
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(DonationDetails.this,SingleBooksDonationDetails.class);
            ...
            public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                View view = LayoutInflater.from(viewGroup.getContext())
                        ...
                        .inflate(R.layout.donor_card, viewGroup, false);
...
/*
       public void details(){
    swipeRefreshLayout.setRefreshing(true);
        FirebaseRecyclerAdapter<Donor,InstaViewHolder> FBRA = new FirebaseRecyclerAdapter<Donor, InstaViewHolder>(Donor.class,R.layout.donor_card,InstaViewHolder.class,mDatabase) {
            @Override
            protected void populateViewHolder(InstaViewHolder viewHolder, Donor model, int position) {
