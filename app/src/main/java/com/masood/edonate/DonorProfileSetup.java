...
public class DonorProfileSetup extends AppCompatActivity {
    private EditText editDisplayContact;
    private ImageView displayImage;
    private static final String TAG1 = "SetupActivity";
...
//    private Uri uri;
   ...
   private static final String TAG = "ConnectionClass-Sample";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_profile_setup);
        ...
        mDatabaseusers = FirebaseDatabase.getInstance().getReference().child("DonorUser");
        ...
        if (Objects.requireNonNull(profile).equals("pic")){
            mDatabaseusers.child(Objects.requireNonNull(mAuth.getCurrentUser()).getUid()).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    Picasso.with(DonorProfileSetup.this).load(image).into(displayImage);
...
*//*
                ...
                //uri = data.getData();
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                    bitmap = Objects.requireNonNull(bundle).getParcelable("data");
                }
...
//        final String user_id = mAuth.getCurrentUser().getUid();
        if (!TextUtils.isEmpty(contact) && resultUri != null) {
            final ProgressDialog progressDialog = new ProgressDialog(DonorProfileSetup.this, R.style.MyAlertDialogStyle);
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.KITKAT) {
                ...
                final StorageReference filepath = mStorageRef.child("donor_profile_image").child(Objects.requireNonNull(mAuth.getCurrentUser()).getUid()).child(Objects.requireNonNull(resultUri.getLastPathSegment()));
    ...
    private class DownloadImage extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if ("No Internet".equalsIgnoreCase(result)) {
                Toast.makeText(DonorProfileSetup.this, "No Internet Available", Toast.LENGTH_SHORT).show();
