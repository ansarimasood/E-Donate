...
public class NgoSingleClothesDonationDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ngo_single_clothes_donation_details);
    ...
    public void acceptButtonClicked(View view){
        ...
        final DatabaseReference Post =  FirebaseDatabase.getInstance().getReference().child("DonationAccepted").child("Clothes").child(mAuth.getCurrentUser().getUid()).push();
                ...
                Post.child("email").setValue(dataSnapshot.child("email").getValue()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()){
                            Toast.makeText(NgoSingleClothesDonationDetails.this,"Donation Accepted",Toast.LENGTH_LONG).show();
                            Intent intent = new Intent(NgoSingleClothesDonationDetails.this,NgoHome.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(intent);
    ...
    public void DonationAccepted(final String time,final String userid){
        final DatabaseReference post = FirebaseDatabase.getInstance().getReference().child("Donors").child("Clothes").child(userid);
                ...
                i = 0;
                  ...
                  for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                      ...
                      Users users = userSnapshot.getValue(Users.class);
                          ...
                          Users usercheck = usersLists.get(i);
