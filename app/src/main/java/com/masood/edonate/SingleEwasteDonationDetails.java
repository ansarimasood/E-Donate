...
public class SingleEwasteDonationDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_ewaste_donation_details);
      ...
      //  mDatabase = FirebaseDatabase.getInstance().getReference().child("Ewaste").child(mCurrentUser);
        ...
        /*if(mAuth.getCurrentUser() != null) {
            mDatabase = FirebaseDatabase.getInstance().getReference().child("Donors").child("Ewaste").child(mAuth.getCurrentUser().getUid());
            ...
            mDatabase.child(post_key).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(mDatabase.child(post_key)==null) {
                        Intent intent = new Intent(SingleEwasteDonationDetails.this,DonationDetails.class);
...
*/
  ...
  deleteButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View v) {
          ...
          final DatabaseReference posts = FirebaseDatabase.getInstance().getReference().child("Ngo").child("Ewaste");
          ...
          Toast.makeText(SingleEwasteDonationDetails.this,"Your Request is Deleted",Toast.LENGTH_LONG).show();
          Intent intent = new Intent(SingleEwasteDonationDetails.this,DonorEwasteDonationDetails.class);
          intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
    ...
    public void CheckDonorInfo(final String post_time,final String ngouid){
        detailsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DatabaseReference post = FirebaseDatabase.getInstance().getReference().child("DonationAccepted").child("Ewaste").child(ngouid);
