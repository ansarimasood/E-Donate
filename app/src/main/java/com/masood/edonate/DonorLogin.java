  ...
  /*  public void loginButtonClicked(View view){
            ...
            mAuth.signInWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (!task.isSuccessful()){
                        Toast.makeText(DonorLogin.this,"Incorrect Login Or Password", Toast.LENGTH_LONG).show();
                    }
                }
            });
    ...
    */
    public void loginButtonClicked(View view){
        ...
        if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(pass)){
            final ProgressDialog progressDialog = new ProgressDialog(DonorLogin.this,R.style.MyAlertDialogStyle);
            ...
            mAuth.signInWithEmailAndPassword(email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    ...
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(DonorLogin.this,"Email or Password is Incorrect",Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild(user_id)){
                    Intent loginIntent = new Intent(DonorLogin.this,Home.class);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(DonorLogin.this,"Session Logged out Successfully", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    public void onBackPressed() {
       /* Intent intent = new Intent(DonorLogin.this,UsersActivity.class);
