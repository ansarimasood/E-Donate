...
public class SingleClothesDonationDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_single_clothes_donation_details);
      ...
      //  mCurrentUser =mAuth.getCurrentUser().getUid();
        ...
        //mDatabase = FirebaseDatabase.getInstance().getReference().child("Books").child(mCurrentUser);
...
/*
        ...
        if(mAuth.getCurrentUser() != null) {
            mDatabase = FirebaseDatabase.getInstance().getReference().child("Donors").child("Clothes").child(mAuth.getCurrentUser().getUid());
            ...
            mDatabase.child(post_key).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if(mDatabase.child(post_key)==null) {
                        Intent intent = new Intent(SingleClothesDonationDetails.this,DonationDetails.class);
    ...
    public void deleteButtonClicked(final String post_time){
        deleteButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DatabaseReference posts = FirebaseDatabase.getInstance().getReference().child("Ngo").child("Clothes");
                ...
                Toast.makeText(SingleClothesDonationDetails.this,"Your Request is Deleted",Toast.LENGTH_LONG).show();
                Intent intent = new Intent(SingleClothesDonationDetails.this,DonorClothesDonationDetails.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
    ...
    public void CheckDonorInfo(final String post_time,final String ngouid){
        detailsButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final DatabaseReference post = FirebaseDatabase.getInstance().getReference().child("DonationAccepted").child("Clothes").child(ngouid);
