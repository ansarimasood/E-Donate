...
public class DonorSignup extends AppCompatActivity {
    ...
    public void submitButtonClicked(View view){
        ...
        if(!TextUtils.isEmpty(Name)&&!TextUtils.isEmpty(Contact) && !TextUtils.isEmpty(Email) && !TextUtils.isEmpty(Password) && !TextUtils.isEmpty(ConfirmPassword)){
            final ProgressDialog progressDialog = new ProgressDialog(DonorSignup.this,R.style.MyAlertDialogStyle);
            ...
            if (Password.equals(ConfirmPassword)) {
                ...
                mAuth.createUserWithEmailAndPassword(Email, Password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(DonorSignup.this,"Successful",Toast.LENGTH_LONG).show();
                            Intent mainIntent = new Intent(DonorSignup.this, DonorProfileSetup.class);
                ...
                Toast.makeText(DonorSignup.this,"Password is mismatched",Toast.LENGTH_LONG).show();

            }
        }
        else {
            Toast.makeText(DonorSignup.this,"Please fill the required details",Toast.LENGTH_LONG).show();
        }
    }
